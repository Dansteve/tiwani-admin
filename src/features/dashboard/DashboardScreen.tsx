...
// The dashboard overview: the "basic reporting / visibility" first cut. A row of KPI cards, a platform
// activity panel, and the always-visible pre-production banner. It reads through the admin-api client
...
// audited admin-api lands, only the client body changes, not this screen.
